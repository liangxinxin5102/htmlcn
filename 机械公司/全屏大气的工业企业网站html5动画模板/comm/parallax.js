...
function boxGoIn_1() {
	 box1In = false;
	$(".b1_01").stop().animate({top: 285, opacity: 0.5}, 1200);
	$(".b1_02").stop().animate({left: 365, opacity: 1}, 1200);
	$(".b1_05").stop().animate({top: 510,  opacity: 0.5}, 1200);
...
function boxGoOut_1() {
	...
	$(".b1_05").stop().animate({top: 300, opacity: 0}, 500);
...
function boxGoIn_2() {
	 box2In = false;
	$(".b2_01").stop().animate({left: 200, top: 110, opacity: 0.6}, 800);
	$(".b2_02").stop().animate({left: 1050, opacity: 1}, 1000);
	$(".b2_07").stop().animate({left: 1050, opacity: 1}, 1000);
}
function boxGoOut_2() {
	 box2In = true;
			...
			box4Timer = setTimeout(function() {
				...
				box4Timer = setTimeout(function() {
					...
					box4Timer = setTimeout(function() {
						...
						$(".b4_02").stop().animate({left: 1100, opacity: 1}, 600);
						box4Timer = setTimeout(function() {
