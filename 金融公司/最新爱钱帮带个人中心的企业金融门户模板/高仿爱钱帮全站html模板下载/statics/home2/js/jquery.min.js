...
<link href="https://www.iqianbang.com/statics/home/css/bootstrap.min.css?" rel="stylesheet" />
<link href="https://www.iqianbang.com/statics/home/css/style.css?" rel="stylesheet" />
<link rel="stylesheet" href="https://www.iqianbang.com/statics/home/css/newPage.css?" />
<link rel="stylesheet" href="https://www.iqianbang.com/statics/home2/css/m2-main.css?">
<link  rel="Shortcut  Icon"  href="https://www.iqianbang.com/statics/home/images/minilogo.png">
<link rel="stylesheet" href="https://www.iqianbang.com/statics/home2/css/m2-main.css?">
<script src="https://www.iqianbang.com/statics/common/js/jquery.js?"></script>
<script src="https://www.iqianbang.com/statics/common/js/common.js?"></script>
<script type="text/javascript" src="https://www.iqianbang.com/statics/home/js/new.common.js"></script>
<script src="https://www.iqianbang.com/statics/common/tipBox/colorbox-master/jquery.colorbox.js?"></script>
...
<style type="text/css">
 ...
 .body_bg{background-color:#f4f5f5;}
    ...
    .btn{
        display:block;
        background: url('https://www.iqianbang.com/statics/home/images/er-btn.png') no-repeat 0 0;
        width: 145px;
        height: 45px;
        font-size: 14px;
...
<!-- 							<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2843215451&site=qq&menu=yes" title='一键加邦德为好友'>邦德 2843215451 </a>&nbsp; -->
	    				...
	    				<div class="mainNew-log">
	    					<ul>
	    					                    <li class="mainNew-re"><a href="/register-index.shtml">注册</a></li>
	    		   <li class="mainNew-re"><a href="/login-index.shtml">登录</a></li>
	    		   <li class="m2-commonTop-btn"><a href="company_finance.html" id="cfpage" style="border-right:none;width: 50px;">企业理财</a></li>
	    		  <li class="mainNew-re"><a href="/ihabout-index.shtml" target="_blank">帮助</a></li>	    						
    ...
    <div class="mainNew-nav">
    				...
    				<div class="mainNewlogo">
						<a href="index.html"><img src="https://www.iqianbang.com/statics/home/images/new-logo.jpg" /></a>
					</div>
...
<div class="block borderbox">
    ...
    <div class='body_bg'>
       <div class="main">
	    <img src="https://www.iqianbang.com/statics/home/images/er-bg.png" class="er_img">
		 <div id='message'>
    <p class="title">非常抱歉，您要查看的页面没有办法找到!<br/>
   
                页面自动 <a id="href" href="index.html">跳转</a>  <b id="wait">3</b>秒后返回首页
                </p>
    <a href="https://www.iqianbang.com" class="btn">返回网站首页</a>
	</div>
</div>
    </div>
        <script type="text/javascript">
...
var GV = {
    DIMAUB: "",
    JS_ROOT: "https://www.iqianbang.com/statics/home/js/",
    TOKEN: "de5292a8b2f102ec233955f20d6a0878_3c7325feb5303f9cde1987667bbf47b1",
    THIS_URL:"Notfound-",
...
<script src="https://www.iqianbang.com/statics/common/js/common.js?"></script>
<link type="text/css" rel="stylesheet" href="https://www.iqianbang.com/statics/common/tipBox/colorbox-master/css/colorbox.css?">
<script src="https://www.iqianbang.com/statics/common/tipBox/layer-v1.5.1/layer/layer.js?"></script>
<script src="https://www.iqianbang.com/statics/common/tipBox/common.js?"></script>
<!--tipBOx-->
<script language=JavaScript type="text/javascript" src="https://www.iqianbang.com/statics/home/js/tab.js?"></script>
