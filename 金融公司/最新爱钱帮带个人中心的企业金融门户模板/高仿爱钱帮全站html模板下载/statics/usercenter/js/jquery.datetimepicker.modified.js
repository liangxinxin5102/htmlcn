...
(function( $ ) {
	...
	$.fn.datetimepicker_uc = function( opt ) {
		var KEY0 = 48,
			KEY9 = 57,
			_KEY0 = 96,
			_KEY9 = 105,
			...
			createDateTimePicker = function( input ) {
				...
				mounth_picker
					.find('.xdsoft_select')
						...
						.on('mousedown.xdsoft','.xdsoft_option',function( event ) {
							...
							loadCalendarInfo(_xdsoft_datetime.currentTime.getFullYear(),_xdsoft_datetime.currentTime.getMonth());
						});
				...
				var _xdsoft_datetime = new function() {
					...
					_this.nextMonth = function() {
						...
						options.onChangeMonth&&options.onChangeMonth.call&&options.onChangeMonth.call(datetimepicker,_xdsoft_datetime.currentTime,datetimepicker.data('input'));
						datetimepicker.trigger('xchange.xdsoft');
						loadCalendarInfo(_this.currentTime.getFullYear(),month);
						return month;
					};
...
//						console.log(_xdsoft_datetime.currentTime.getFullYear());
//						console.log(_xdsoft_datetime.currentTime.getMonth());
//						timerclick++;
...
//							return false;
						...
						if( $this.hasClass('xdsoft_other_month') )
							return false;
						if(typeof(getPaymentList)!='undefined'){
							getPaymentList(_xdsoft_datetime.currentTime.getFullYear(),_xdsoft_datetime.currentTime.getMonth()+1,$this.data('date'));
						}
