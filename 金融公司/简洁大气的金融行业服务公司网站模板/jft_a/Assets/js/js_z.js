$(function(){
	...
	$('.i_pro li:last-child').css('margin-right',0+'px');
	$('.news_a dl:last-child').css('margin-right',0+'px');
	$('.s_nav ul li:last-child').css('border-bottom',0+'px');
	...
	$('.p_nav a:last-child').css('border-right','1px solid #0E58AA');
	$('.p_bm dl:nth-child(2n)').css('margin-right',0+'px');
	$('.p_dm ul li:last-child').css('margin-right',0+'px');
	$('.jm_e li:last-child').css('margin-right',0+'px');
