...
KindEditor.plugin('filemanager', function(K) {
	var self = this, name = 'filemanager',
		fileManagerJson = K.undef(self.fileManagerJson,'/e/incs/kindeditor/asp.net/file_manager_json.ashx'),
...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		uploadJson = K.undef(self.uploadJson, '/e/incs/kindeditor/asp.net/upload_json.ashx');
	self.plugin.flash = {
		edit : function() {
			var html = [
