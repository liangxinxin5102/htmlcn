...
function Ok()
{
	...
	for ( var i = 0 ; i < aLinks.length ; i++ )
	{
		...
		//oLink.innerHTML = sInnerHtml ;		 Set (or restore) the innerHTML
                var tempInnerHtml = decodeURI(sInnerHtml);      // pageadmin.net zdy
                tempInnerHtml = tempInnerHtml.substring(tempInnerHtml.lastIndexOf('/')+1,tempInnerHtml.length);
                var stype=tempInnerHtml.substring(tempInnerHtml.lastIndexOf('.')+1,tempInnerHtml.length);//get houzui
                var oLink_type;
                switch(stype)
                {
		case 'bmp':
                   oLink_type="background:url(/e/images/icon/bmp.gif) no-repeat;padding-left:17px";
		break;
		case 'png':
                   oLink_type="background:url(/e/images/icon/png.gif) no-repeat;padding-left:17px";
		break;
		 case 'ppt':
                   oLink_type="background:url(/e/images/icon/ppt.gif) no-repeat;padding-left:17px";
		break;
		case 'jpg':
                   oLink_type="background:url(/e/images/icon/jpg.gif) no-repeat;padding-left:17px";
		break;
		case 'jpeg':
                   oLink_type="background:url(/e/images/icon/jpg.gif) no-repeat;padding-left:17px";
		break;
		case 'gif':
                   oLink_type="background:url(/e/images/icon/gif.gif) no-repeat;padding-left:17px";
		break;
		case 'doc':
                   oLink_type="background:url(/e/images/icon/doc.gif) no-repeat;padding-left:17px";
		break;
		 case 'docx':
                   oLink_type="background:url(/e/images/icon/doc.gif) no-repeat;padding-left:17px";
		 break;
		case 'xls':
                  oLink_type="background:url(/e/images/icon/xls.gif) no-repeat;padding-left:17px";
		break;
		case 'mdb':
                   oLink_type="background:url(/e/images/icon/mdb.gif) no-repeat;padding-left:17px";
		break;
		case 'pdf':
                   oLink_type="background:url(/e/images/icon/pdf.gif) no-repeat;padding-left:17px";
		break;
		case 'js':
                   oLink_type="background:url(/e/images/icon/js.gif) no-repeat;padding-left:17px";
		break;
		case 'mdb':
                   oLink_type="background:url(/e/images/icon/mdb.gif) no-repeat;padding-left:17px";
		break;
		case 'swf':
                   oLink_type="background:url(/e/images/icon/swf.gif) no-repeat;padding-left:17px";
		break;
		case 'rar':
                   oLink_type="background:url(/e/images/icon/rar.gif) no-repeat;padding-left:17px";
		break;
		case 'zip':
                   oLink_type="background:url(/e/images/icon/zip.gif) no-repeat;padding-left:17px";
		break;
		default:
                   oLink_type="";
		break;
                ...
                if(oLink_type!="")
                 {
                  GetE('txtAttStyle').value=oLink_type;
