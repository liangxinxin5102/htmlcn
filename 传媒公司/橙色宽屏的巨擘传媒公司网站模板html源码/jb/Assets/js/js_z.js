$(function(){
	...
	$('.case_l li:nth-child(4n)').css('margin-right',0+'px');
	$('.case .tabBox .tabNav li:last-child').css('border-right','1px solid #FFF');
	$('.case .tabBox .tabNav li:first-child').css('border-left','0px');
});
//左右点击滚动
