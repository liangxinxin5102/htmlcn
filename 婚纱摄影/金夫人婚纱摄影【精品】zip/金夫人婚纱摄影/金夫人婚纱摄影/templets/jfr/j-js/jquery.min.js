...
window.Rainbow = function() {
    ...
    function B(a, b) {
        for (var c in f[d]) {
            c = parseInt(c, 10);
            if (a == c && b == f[d][c] ? 0 : a <= c && b >= f[d][c]) delete f[d][c],
            delete j[d][c];
    ...
    function r(a, b, c, i) {
        if ("undefined" === typeof a || null === a) i();
            ...
            var e = a.exec(c);
            if (e) {++s; ! b.name && "string" == typeof b.matches[0] && (b.name = b.matches[0], delete b.matches[0]);
                var k = e[0],
                g = e.index,
                t = e[0].length + g,
                h = function() {
                    ...
                    l = function(a, c, i) {
                        if (a >= c.length) i(k);
                            ...
                            if (d) {
                                ...
                                function(a) {
                                    j(d, a)
                                }) : typeof g === "string" ? j(d, d, g) : v(d, h.length ? h: [h],
                                function(a) {
    ...
    function v(a, b, c) {
        function i(b, k) {
            k < b.length ? r(b[k].pattern, b[k], a,
            function() {
                i(b, ++k)
            }) : C(a,
            function(a) {
    ...
    function o(a, b, c) {
        if (b < a.length) {
            var d = a[b],
            e = A(d);
            return ! ( - 1 < (" " + d.className + " ").indexOf(" rainbow ")) && e ? (e = e.toLowerCase(), d.className += d.className ? " rainbow": "rainbow", n(d.innerHTML, e,
            function(k) {
                d.innerHTML = k;
                j = {};
                f = {};
...
$('.slideshowConfig input').bind('change',
function() {
    reloadSlideshow()
