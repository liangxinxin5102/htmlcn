$().ready(function() {
    $(".index-num-0").removeClass("active");
    $(".index-num-1").removeClass("active");
    $(".index-num-2").removeClass("active");
    $(".index-num-3").removeClass("active");
    $(".index-num-4").removeClass("active");
    $(".index-num-5").removeClass("active");
    $(".index-num-6").removeClass("active");
    $(".index-num-7").removeClass("active");
    $(".index-num-8").removeClass("active");
    $(".index-num-9").removeClass("active");
});
/*右侧悬浮*/
$(function(){
    var src=path+"images/weixin.jpg";
    var tophtml="<div id=\"izl_rmenu\" class=\"izl-rmenu\"><a href=\"http://q.url.cn/s/IygMzVm\" target=\"_blank\" class=\"btn1 btn-qq\" id=\"webqq\"></a><div class=\"btn1 btn-wx\"><img  class=\"pic\" src=\""+src+"\" /></div><div class=\"btn1 btn-phone\"><div class=\"phone\">Tel: 4001-021-758</div></div><div class=\"btn1 btn-top\"></div></div>";
    $("#top").html(tophtml);
...
$(function() {
    $('li[topnav]').hover(function() {
        ...
        var heht = $(this).find('#' + it).height() +180 + "px";
        //alert($(this).find('#' + it).height());
...
function sendSms(){
  ...
  $.post('sms.php?act=sendsms', {mobile: mobile, hash: hash}, function(data){
...
//表单验证
$(function(){
    if($("form").hasClass("validform")){
        $(".validform").Validform({
            ajaxPost: true,
            tipSweep: true, //表单提交时验证
            ...
            callback: function(data){
				if(data.license != undefined) {
					if (data.code == 0) {
						...
						$('#exampleModal p.lice-succeed-cont').find('label:eq(0)').html(data.site.domain);
						$('#exampleModal p.lice-succeed-cont').find('label:eq(1)').html('ECTOUCH微商城');
						$('#exampleModal p.lice-succeed-cont').find('label:eq(2)').html('终生授权');
						$('#exampleModal p.lice-succeed-cont').find('label:eq(3)').html(data.site.id);
						$('#exampleModal p.lice-succeed-cont').find('label:eq(4)').html(data.site.now);
						$('#exampleModal p.lice-succeed-cont').find('label:eq(5)').html(data.site.nextYear);
						$('#exampleModal p.lice-succeed-cont').find('label:eq(6)').html(data.site.company);
						$('#exampleModal p.lice-succeed-cont').find('label:eq(7)').html(data.site.companySite);
						$('#exampleModal p.lice-succeed-cont').find('label:eq(8)').html(data.site.now);
						$('#exampleModal .modal-body.success').css('display', 'block');
						$('#exampleModal .modal-body.failed').css('display', 'none');
					}else if(data.code == 2){
						$('#exampleModal').modal("show");
						$('#exampleModal .modal-body.success').css('display', 'none');
						$('#exampleModal .modal-body.failed').css('display', 'block');
						$('#exampleModal .modal-body.failed .my-col-md-6 label').html($('#sites-domain').val());
					}else{
						layer.msg(data.msg);
					}
				}else{
...
$(function( $) {
   ...
   $(".gnty-img-box").mouseover(function () {
           $(this).addClass("active" );
      });
      $( ".gnty-img-box" ).mouseout(function() {
           $(this).removeClass("active" );
      });
       $(".pro-an-my").click(function () {
           $(this).addClass("active" );
      });
      $( ".pro-an-my" ).click(function() {
           $(this).removeClass("active" );
...
//顶部
     	$(window).scroll(function(){
			...
			if ($(window).scrollTop() > 200) {
				$(".app-top").addClass("active");
			} else {
				$(".app-top").removeClass("active");
			};
