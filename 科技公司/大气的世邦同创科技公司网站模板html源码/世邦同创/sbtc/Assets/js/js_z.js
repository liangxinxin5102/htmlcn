$(function(){
	...
	$('.i_mb dl:last-child').css('margin-right',0+'px');
	$('.lei li:last-child').css('margin-right',0+'px');
	$('.about_b li:nth-child(4n)').css('margin-right',0+'px');
	$('.news_b li:nth-child(4n)').css('margin-right',0+'px');
	$('.pro_ml li:nth-child(4n)').css('margin-right',0+'px');
	$('.about_d tr td:nth-child(2n)').css('border-left','1px solid #ddd');
	$('#spec-list ul li:last-child').children('img').css('border-right',0+'px !important');
	
	$('.pro_db span').click(function(){
