...
$(function(){
	...
	$(".tabBox .tabNav li").click(function(){
		...
		$(this).addClass("now");
		$(this).parents(".tabnav_bg").parents(".tabBox").find(".tabCont").css("display","none");
		var i=$(this).index();
		$(this).parents(".tabnav_bg").parents(".tabBox").find(".tabCont:eq("+i+")").css("display","block");
	});
	//滑动门
	$(".tabBox .tabCont:first").css("display","block");
	$(".tabBox .tabNav li").click(function(){
	...
	//导航产品
	$('.xia .tabBox .tabCont ul li:last-child').css('background','none');
	$('.nav li').mousemove(function(){
		$(this).children('.xia').show();
	});
	$('.nav li').mouseleave(function(){
		$(this).children('.xia').hide();
	});
	$('.nav li .xia').mouseleave(function(){
		$(this).children('.xia').hide();
	});
	
	//产品列表
	$('.pro_l .tabBox .tabNav li:last-child').css('border-right',0+'px');
	$('.pro_l .xz li .li_r a:last-child').css('border-right',0+'px');
})
