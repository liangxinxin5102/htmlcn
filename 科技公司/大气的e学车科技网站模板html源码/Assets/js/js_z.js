$(function(){
	...
	$('.tabBox .tabNav li:first-child').css('margin-left',500+'px');
	$('.tabBox .tabCont ul li:first-child').css('margin-left',500+'px');
	$('.head .nav li.xia').mouseover(function(){
		$('.head .xm_bg').show();
	});
	$('.head .nav li.xia').mouseleave(function(){
		$('.head .xm_bg').hide();
	});
	$('.head .xm_bg').mouseleave(function(){
		$(this).hide();
	});
	$('.head .xm_bg').mouseover(function(){
		$(this).show();
	});
	
	$('.head .nav li.xia_a').mouseover(function(){
		$('.head .xm_bg_a').show();
	});
	$('.head .nav li.xia_a').mouseleave(function(){
		$('.head .xm_bg_a').hide();
	});
	$('.head .xm_bg_a').mouseleave(function(){
		$(this).hide();
	});
	$('.head .xm_bg_a').mouseover(function(){
		$(this).show();
	});
	$('.head .nav li.xia_b').mouseover(function(){
		$('.head .xm_bg_b').show();
	});
	$('.head .nav li.xia_b').mouseleave(function(){
		$('.head .xm_bg_b').hide();
	});
	$('.head .xm_bg_b').mouseleave(function(){
		$(this).hide();
	});
	$('.head .xm_bg_b').mouseover(function(){
		$(this).show();
	});
	
	$('.f_nav li:last-child').css('margin-right',0+'px');
	
	$('.scd .scd_h a:last-child').css('border',0+'px');
	$('.scd .scd_h a:first-child').css('padding-left',0+'px');
	
	$('.support ul li:nth-child(2n)').css('margin-right',0+'px');
})
