...
$(function(){
	...
	$('.frd_m li:nth-child(4n)').css('margin-right',0+'px');
	$('.pro_l .p_lei a:last-child').css('border',0+'px');
	$('.pro_l ul li:nth-child(3n)').css('margin-right',0+'px');
	$('.i_prom .lei ul li:last-child').css('border',0+'px');
	$('.nav_m ul li:last-child').css('border',0+'px');
	
	$('.i_prom .lei ul li').click(function(){
