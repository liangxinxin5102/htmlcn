$(function(){
	...
	$('.i_news dl:nth-child(2n)').css('margin-right',0+'px');
	$('.bd li:nth-child(2n)').css('margin-right',0+'px');
	
	$('.news dl:nth-child(2n)').css('padding-left',20+'px');
	$('.pro_m ul li:nth-child(3n)').css('margin-right',0+'px');
});
//左右点击滚动
